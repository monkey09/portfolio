<template>
  <v-main>
    ...
    <PageServices />
    <PageTitle id="portfolio" title="Portfolio" text="showcases some of the projects I've worked on over the years. From simple static websites to complex dynamic applications." son0="#F4F8FA" son1="#E9F3F8" />
    <PageRecent />
    <PageTitle id="stack" title="Stack" text="I know HTML, CSS, JavaScript, Vue, Nuxt, React, Next, and other web development technologies." son0="#E9F3F8" son1="#F4F8FA" />
    <PageStack />
    <PageTitle id="news" title="Teck News" text="Latest feeds about the technical industry!" son0="#F4F8FA" son1="#E9F3F8" />
    <PageNews />
